...
public class DiscordEndpointPage extends Page {
    ...
    public DiscordEndpointPage(ConfigurationLoader.Configuration configuration, Database database) {
    ...
    protected Object execute(Request request, Response response, Model.Builder builder) {
        ...
        DiscordAccount account = new DiscordAccountImpl(request.session(), clientId, clientSecret, body.getString("access_token"),
